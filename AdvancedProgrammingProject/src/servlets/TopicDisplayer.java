...
//            System.out.println("updated topic "+topic);
            ...
            toClient.flush();
//        } else if (requestInfo.getParameters().containsKey("IncTopic")) { // Adding topic for IncAgent
//            String topic=requestInfo.getParameters().get("IncTopic");
//            String direction=requestInfo.getParameters().get("To-From");
//
//            TopicManagerSingleton.get().getTopic(topic).subscribe();
//        }
